...
public class Cache {
	...
	private long NH1;
	private long NH2;
	private LinkedList<String> myCache1;
	private LinkedList<String> myCache2;
	...
	public Cache(int cSize1){
		cacheSize1 = cSize1;
		myCache1 = new LinkedList<String>();
		NR1 =0;
		NH1 =0;
	...
	public Cache(int cSize1, int cSize2){
		...
		cacheSize2 = cSize2;
		myCache1 = new LinkedList<String>();
		myCache2 = new LinkedList<String>();
		NR1 =0;
		NR2 =0;
		NH1 =0;
		NH2 =0;
	 ...
	 */
	public String getObject(String aWord) {
		String returnVal = "Not in Cache";
	 ...
	 * @param aWord the String object to be added to the cache
	 */
	public void addObject(String aWord){
		NR1++;
		if(myCache1.contains(aWord)){	//word is in 1st cache
			NH1++;
			myCache1.remove(aWord);
			myCache1.addFirst(aWord);
			if(isDoubleLevel){
				myCache2.remove(aWord);
				myCache2.addFirst(aWord);
			}
			...
			if(isDoubleLevel){
				NR2++;
				if(myCache2.contains(aWord)){		//word is in cache2
					NH2++;
					myCache2.remove(aWord);
					myCache2.addFirst(aWord);				
